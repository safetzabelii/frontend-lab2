...
export default observer(function ChangePassword(){
  ...
  <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-6 text-center text-3xl font-extrabold text-green-800">Change your password</h2>
      </div>
              ...
              <Form className="space-y-6" onSubmit={formik.handleSubmit}>
                ...
                <div>
                  ...
                  <div className="mt-1 relative">
                    ...
                    />
                    <span className="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer" onClick={toggleShowCurrentPassword}>
                      {showPassword ? <FaEyeSlash className="h-5 w-5 text-gray-400" /> : <FaEye className="h-5 w-5 text-gray-400" />}
                    </span>
                  </div>
                  {formik.touched.newPassword && formik.errors.currentPassword && (
